...
var createAuthUserData = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var token, password, otherUserData;
    return __generator(this, function (_a) {
        token = jwt.sign({
            email: user.email
        }, enums_1.Secret.Secret, { expiresIn: '30d' });
        password = user.password, otherUserData = __rest(user, ["password"]);
        return [2 /*return*/, Promise.resolve(__assign({ token: token }, otherUserData))];
    });
}); };
exports.createAuthUserData = createAuthUserData;
//# sourceMappingURL=createAuthUserData.js.map